...
frida-import-raw:
    ...
    for f in grim_hits.jsonl crimsonland_frida_hits.jsonl demo_trial_overlay_trace.jsonl demo_idle_threshold_trace.jsonl screen_fade_trace.jsonl ui_render_trace.jsonl; do \
