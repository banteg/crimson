...
| 11 | perk_id_evil_eyes (DAT_004c2b88) | Evil Eyes | No living (nor dead) can resist the hypnotic power of your eyes: monsters freeze still as you look at them! |  | Target creature index stored in `evil_eyes_target_creature` (`DAT_00490bbc`), set in `FUN_00406b40`, read in `creature_update_all`. |
