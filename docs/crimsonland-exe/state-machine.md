...
| --- | --- | --- |
| `game_state_id` (`DAT_00487270`) | current state id | set in `FUN_004461c0`, checked throughout render/update loops |
| `game_state_prev` (`DAT_0048726c`) | previous state id | set in `FUN_004461c0` before changing state |
...
| `ui_transition_alpha` (`DAT_00487278`) | transition alpha | computed in `FUN_00405960` from timeline |
