...
| `5` | pause (console/mod pause) | `FUN_0040e690` sets `DAT_00487274 = 5` on `game_pause` |
...
| `0x16` | modal/plugin flow | `FUN_0040b630` drives a DLL-backed interface (`DAT_004824d4`) when 0x16 |
...
- `game_pause` (console/mod command) sets `DAT_00487274 = 5`.
