...
- Rollback netplay is primary (relay + room codes); remaining hardening work is focused on packet-impairment stress runs and lockstep legacy fallback maintenance.
