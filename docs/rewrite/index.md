...
- Rollback netplay is primary (relay + room codes, protocol v5, reconnect/resync hooks); Zig now has delayed-input and reordered-input correction smoke paths, and remaining hardening work is focused on broader packet-impairment stress runs plus lockstep fallback maintenance.
