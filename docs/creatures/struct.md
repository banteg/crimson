...
| `0x10` | hitbox size | `creature_hitbox_size` | set to `16.0` on spawn; used as a sentinel in contact-damage logic and as an AoE eligibility gate (`creatures_apply_radius_damage`: `lifecycle_stage > 5.0`). |
