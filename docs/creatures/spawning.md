...
- `src/crimson/spawn_templates.py` is a partial, hand-maintained index (type/flags plus a few fixed constants).
- `src/crimson/spawn_plan.py` is the start of a 1:1 rewrite of the algorithm as a pure plan builder.
