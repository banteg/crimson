...
pub const quest_results = @import("quest_results.zig");
...
test {
    ...
    _ = @import("runtime/replay/commands.zig");
    _ = @import("runtime/replay_info.zig");
    _ = replay_runner;
    _ = verify_native;
    _ = replay_info_native;
    _ = @import("replay_list_native.zig");
    _ = replay_benchmark_native;
    _ = checkpoint_diff_native;
    _ = dbg_record_native;
    _ = dbg_verify_native;
    _ = effects;
    _ = projectiles;
