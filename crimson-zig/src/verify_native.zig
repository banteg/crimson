...
fn buildOutputForReplayCodecError(
    ...
    switch (err) {
        error.InvalidMsgpack => return buildVerifyFailedOutput(allocator, "replay payload does not match format 16 msgpack schema"),
        ...
        error.UnsupportedInputShape => return buildVerifyFailedOutput(allocator, "replay tick inputs do not match format 16"),
        error.UnsupportedEventShape => return buildVerifyFailedOutput(allocator, "replay tick operations do not match format 16"),
        ...
        error.UnknownCommandKind => return buildVerifyFailedOutput(allocator, "replay tick operations do not match format 16"),
...
test "replay codec invalid replay errors map to verify failed output" {
    ...
    const cases = [_]struct {
        ...
        .{ .err = error.InvalidMsgpack, .detail = "replay payload does not match format 16 msgpack schema" },
        ...
        .{ .err = error.UnsupportedInputShape, .detail = "replay tick inputs do not match format 16" },
        .{ .err = error.UnsupportedEventShape, .detail = "replay tick operations do not match format 16" },
        ...
        .{ .err = error.UnknownCommandKind, .detail = "replay tick operations do not match format 16" },
