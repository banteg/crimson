...
pub fn prepareSimulationContext(
...
) replay_context_mod.SimulationContextError!replay_context_mod.SimulationContext {
    ...
    var quest_spawn_entries_storage: [max_sim_quest_spawn_entries]spawn_mod.QuestSpawnEntry = undefined;
    ...
    var context = try replay_context_mod.SimulationContext.initFromReplayHeader(
        header,
        .{
