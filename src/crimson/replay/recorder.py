...
class ReplayRecorder:
    ...
    def _default_tick_dt_ms_i32(self) -> int:
    ...
    def record_tick(self, inputs: Sequence[PlayerInput], *, dt_ms_i32: int | None = None) -> int:
        ...
        tick_dt_ms_i32 = self._default_tick_dt_ms_i32() if dt_ms_i32 is None else int(dt_ms_i32)
        if tick_dt_ms_i32 <= 0:
            raise ValueError(f"dt_ms_i32 must be > 0, got {tick_dt_ms_i32}")

        tick_index = int(self._tick_index)
        self._inputs.append(tick)
        self._dt_ms_i32.append(int(tick_dt_ms_i32))
        self._tick_index += 1
        return tick_index
    ...
    def record_tick_at(
        ...
        *,
        ...
        if target < length:
            ...
            self._dt_ms_i32[target] = int(tick_dt_ms_i32)
