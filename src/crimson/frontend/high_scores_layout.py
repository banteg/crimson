...
HS_LOCAL_DATE_CENTER_X = 152.0  # decompile: date centered around (base_x + 152)
...
HS_LOCAL_CLOCK_X = 194.0  # ui_clockTable/ui_clockPointer bbox [824,312]..[856,344]
HS_LOCAL_CLOCK_Y = 103.0
