        ...
        try:
            self._driver = PlaybackDriver(
                ...
                PlaybackDriverOptions(
                    ...
                    quest_partition_events=False,
                    defer_menu_open=False,
                    rush_force_strict_events=False,
                    rush_pass_dt_frame_ms_i32=False,
                    rush_enforce_loadout=True,
                    quest_manual_finalize_post_render_lifecycle=False,
                    quest_disable_capture_spawn_events_authoritative=False,
                    quest_finalize_post_render_lifecycle_each_tick=True,
