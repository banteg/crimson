...
QUESTS = [
    QuestDefinition("5.1", "The Beating", build_5_1_the_beating),
    QuestDefinition("5.2", "The Spanking Of The Dead", build_5_2_the_spanking_of_the_dead),
    QuestDefinition("5.3", "The Fortress", build_5_3_the_fortress),
    QuestDefinition("5.4", "The Gang Wars", build_5_4_the_gang_wars),
    QuestDefinition("5.5", "Knee-deep in the Dead", build_5_5_knee_deep_in_the_dead),
    QuestDefinition("5.6", "Cross Fire", build_5_6_cross_fire),
    QuestDefinition("5.7", "Army of Three", build_5_7_army_of_three),
    QuestDefinition("5.8", "Monster Blues", build_5_8_monster_blues),
    QuestDefinition("5.9", "Nagolipoli", build_5_9_nagolipoli),
    QuestDefinition("5.10", "The Gathering", build_5_10_the_gathering),
]
