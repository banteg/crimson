...
def test_reliable_packet_is_acked_and_removed() -> None:
    ...
    messages, is_dup = receiver.ingest_packet(packet, now_ms=1000)
    ...
    sender.ingest_packet(ack, now_ms=1001)
...
def test_duplicate_reliable_packet_is_dropped() -> None:
    ...
    messages0, dup0 = receiver.ingest_packet(packet, now_ms=10)
    messages1, dup1 = receiver.ingest_packet(packet, now_ms=10)
