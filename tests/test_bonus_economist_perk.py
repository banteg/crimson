...
def test_bonus_economist_extends_bonus_timers() -> None:
    ...
    bonus_apply(base_state, base_player, BonusId.DOUBLE_EXPERIENCE, amount=10, creatures=[], players=[base_player])
    ...
    bonus_apply(perk_state, perk_player, BonusId.DOUBLE_EXPERIENCE, amount=10, creatures=[], players=[perk_player])
