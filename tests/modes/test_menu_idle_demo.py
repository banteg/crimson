...
from crimson.screens.chrome import MENU_DEMO_IDLE_START_MS, MenuEntry
...
def test_menu_demo_idle_starts_demo(mocker, make_game_state) -> None:
    ...
    view._chrome.chrome.timeline_max_ms = 0
    ...
    view.update(0.0)
    assert view._chrome.chrome.closing is True
...
def test_menu_idle_does_not_start_demo_in_full_version(mocker, make_game_state) -> None:
    ...
    assert view._chrome.chrome.closing is False
