...
def test_data_map_preserves_recovered_crt_and_weapon_alias_types():
    ...
    expected = {
        ...
        "0x0047b6f4": ("crt_lock_table", "void *[48]"),
        "0x0047b7c0": (
            "crt_dosmaperr_table",
        ...
        "0x0047baf0": ("crt_old_small_block_heap", "unsigned char[8224]"),
        ...
        "0x0047dd10": ("crt_fdiv_risc_table", "unsigned char[16]"),
        "0x0047dd20": ("crt_fdiv_scale_1", "unsigned char[4]"),
        "0x0047dd24": ("crt_fdiv_scale_2", "unsigned char[4]"),
        "0x0047dd28": ("crt_fdiv_one_shl_63", "unsigned char[4]"),
        "0x0047dd2c": ("crt_fprem_risc_table", "unsigned char[24]"),
        "0x0047dd44": ("crt_fdiv_one_shl_64", "unsigned char[8]"),
        "0x0047dd4c": ("crt_fdiv_one_shr_64", "unsigned char[16]"),
        "0x0047dd5c": ("crt_fdiv_half", "unsigned char[8]"),
        "0x0047dd64": ("crt_fdiv_big_number", "unsigned char[10]"),
        "0x0047dd6e": ("crt_fdiv_dispatch_table", "unsigned char[258]"),
        ...
        "0x0047e180": ("crt_pow10_positive", "unsigned char[352]"),
        "0x0047e2e0": ("crt_pow10_negative", "unsigned char[348]"),
        "0x0046f9e0": ("crt_ehvec_ctor_scope_table", "unsigned char[12]"),
        "0x0046f9f0": ("crt_ehvec_dtor_scope_table", "unsigned char[12]"),
        "0x0046fa00": ("crt_array_unwind_scope_table", "unsigned char[12]"),
        "0x0046fa68": ("crt_start_scope_table", "unsigned char[12]"),
        "0x0046fb98": ("crt_terminate_scope_table", "unsigned char[24]"),
        "0x0046fbb0": ("crt_inconsistency_scope_table", "unsigned char[24]"),
        "0x0046fbc8": ("crt_four_nul_literal", "char[4]"),
        "0x0046fbd0": ("crt_lcmap_string_scope_table", "unsigned char[24]"),
        "0x0046ffd0": ("crt_frame_unwind_scope_table", "unsigned char[12]"),
        "0x0046ffe0": ("crt_call_catch_block_scope_table", "unsigned char[24]"),
        "0x0046fff8": ("crt_build_catch_object_scope_table", "unsigned char[12]"),
        "0x00470008": ("crt_destruct_exception_scope_table", "unsigned char[12]"),
        "0x00470018": ("crt_get_string_type_a_scope_table", "unsigned char[12]"),
        "0x004701b8": ("crt_compare_string_a_scope_table", "unsigned char[24]"),
        ...
        "0x004d9a68": ("crt_standard_buffers", "char *[2]"),
        "0x004d9b98": ("crt_timezone_info", "unsigned char[172]"),
        "0x004d9cd8": ("crt_file_mode", "int"),
        "0x004ab1a8": ("crt_two_nul_literal", "char[2]"),
