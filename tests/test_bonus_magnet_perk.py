...
def test_bonus_magnet_allows_bonus_spawn_on_secondary_roll() -> None:
    ...
    base_player = PlayerState(index=0, pos_x=0.0, pos_y=0.0, weapon_id=int(WeaponId.ASSAULT_RIFLE))
    ...
    perk_player = PlayerState(index=0, pos_x=0.0, pos_y=0.0, weapon_id=int(WeaponId.ASSAULT_RIFLE))
