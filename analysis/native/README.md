...
pins their repository-relative staging path, provenance source member or
deterministic derived-artifact recipe, size, and SHA-256. A native link fails
on a missing or drifted archive and verifies each configured reference export
in the generated PE import table.
