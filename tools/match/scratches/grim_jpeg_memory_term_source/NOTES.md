...
caller-owned, so termination intentionally performs no work. The scratch now
selects that callback directly from the canonical recovered provider
translation unit and its pinned `/O2 /G6 /W3 /MD` profile.
