...
extern "C" void config_init_defaults(void)
{
    ...
    *(int *)&config_blob.reserved1_1a4[0] = 100;
    ...
    config_blob.input_config[0].move_key_forward = 17;
    config_blob.input_config[0].move_key_backward = 31;
    config_blob.input_config[0].turn_key_left = 30;
    config_blob.input_config[0].fire_key = 256;
    config_blob.input_config[0].key_reserved_0 = 382;
    config_blob.input_config[0].key_reserved_1 = 382;
    config_blob.input_config[0].aim_key_left = 16;
    config_blob.input_config[0].aim_key_right = 18;
    config_blob.input_config[0].axis_aim_y = 319;
    config_blob.input_config[0].axis_aim_x = 320;
    config_blob.input_config[0].axis_move_y = 321;
    config_blob.input_config[0].axis_move_x = 339;
    config_blob.input_config[0].reserved[0] = 382;
    config_blob.input_config[0].reserved[1] = 382;
    config_blob.input_config[0].reserved[2] = 382;

    config_blob.input_config[1].move_key_forward = 200;
    config_blob.input_config[1].move_key_backward = 208;
    config_blob.input_config[1].turn_key_left = 203;
    config_blob.input_config[1].turn_key_right = 205;
    config_blob.input_config[1].fire_key = 157;
    config_blob.input_config[1].key_reserved_0 = 382;
    config_blob.input_config[1].key_reserved_1 = 382;
    config_blob.input_config[1].aim_key_left = 211;
    config_blob.input_config[1].aim_key_right = 209;
    config_blob.input_config[1].axis_aim_y = 319;
    config_blob.input_config[1].axis_aim_x = 320;
    config_blob.input_config[1].axis_move_y = 321;
    config_blob.input_config[1].axis_move_x = 339;
    config_blob.input_config[1].reserved[0] = 382;
    config_blob.input_config[1].reserved[1] = 382;
    config_blob.input_config[1].reserved[2] = 382;
