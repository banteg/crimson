...
void ui_element_load(ui_menu_item_subtemplate_block_t *element, char *jaz_path);
void ui_element_set_rect(ui_menu_item_subtemplate_block_t *element, float width,
...
static __forceinline void set_rect(ui_layout_element_t &element, float width,
    float height, float offset_x, float offset_y)
{
    ui_layout_vec2_t offset(offset_x, offset_y);
    ui_element_set_rect(&element.layers[1], width, height, &offset.x);
}

static __forceinline void set_atlas_row(ui_layout_element_t &element, int row)
{
    ui_menu_item_subtemplate_block_t &atlas = element.layers[1];
    float top = (float)row * 0.125f;
    float bottom = (float)(row + 1) * 0.125f;
    *(ui_layout_vec2_t *)&atlas.slot_00.u = ui_layout_vec2_t(0.0f, top);
    *(ui_layout_vec2_t *)&atlas.slot_01.u = ui_layout_vec2_t(1.0f, top);
    *(ui_layout_vec2_t *)&atlas.slot_02.u = ui_layout_vec2_t(1.0f, bottom);
    *(ui_layout_vec2_t *)&atlas.slot_03.u = ui_layout_vec2_t(0.0f, bottom);
}
...
static __forceinline void translate_layer(
    ui_menu_item_subtemplate_block_t &layer, float x, float y)
{
    for (int i = 0; i < 4; ++i) {
...
extern "C" void ui_menu_layout_init(void)
{
    ...
    ui_element_table_slot_01_main_menu_aux = &ui_element_slot_01_main_menu_aux;
    ui_element_table_slot_02_main_menu_primary = &ui_element_slot_02_main_menu_primary;
    ui_element_table_slot_03_main_menu_play_game
        = &ui_element_slot_03_main_menu_play_game;
    ui_element_table_slot_04_main_menu_options = &ui_element_slot_04_main_menu_options;
    ...
    if (!grim_interface_ptr->grim_get_config_var(100)) {
        ui_element_table_slot_07_main_menu_footer_b = &ui_element_slot_footer_variant_a;
        ui_element_table_slot_06_main_menu_footer_a = &ui_element_slot_footer_variant_b;
    } else {
        ui_element_table_slot_06_main_menu_footer_a = &ui_element_slot_footer_variant_a;
        ui_element_table_slot_07_main_menu_footer_b = &ui_element_slot_footer_variant_b;
    }
    ...
    copy_layer(ui_element_slot_02_main_menu_primary, ui_menu_item_element);
    ui_element_slot_02_main_menu_primary.pos = ui_layout_vec2_t(-60.0f, 210.0f);
    set_rect(ui_element_slot_02_main_menu_primary, 124.0f, 30.0f, 270.0f, -38.0f);
    ...
    copy_layer(ui_element_slot_03_main_menu_play_game, ui_menu_item_element);
    ui_element_slot_03_main_menu_play_game.pos = ui_layout_vec2_t(-60.0f, 270.0f);
    set_rect(ui_element_slot_03_main_menu_play_game, 124.0f, 30.0f, 270.0f, -38.0f);
    ui_element_slot_03_main_menu_play_game.on_activate = ui_menu_main_click_play_game;
    ui_element_slot_03_main_menu_play_game.label_id = 25;

    copy_layer(ui_element_slot_04_main_menu_options, ui_menu_item_element);
    ui_element_slot_04_main_menu_options.pos = ui_layout_vec2_t(-60.0f, 330.0f);
    set_rect(ui_element_slot_04_main_menu_options, 124.0f, 30.0f, 270.0f, -38.0f);
    ui_element_slot_04_main_menu_options.on_activate = ui_menu_main_click_options;
    ui_element_slot_04_main_menu_options.label_id = 24;

    copy_layer(ui_element_slot_05_main_menu_statistics, ui_menu_item_element);
    ui_element_slot_05_main_menu_statistics.pos = ui_layout_vec2_t(-60.0f, 390.0f);
    set_rect(ui_element_slot_05_main_menu_statistics, 124.0f, 30.0f, 270.0f, -38.0f);
    ui_element_slot_05_main_menu_statistics.on_activate = ui_menu_main_click_statistics;
    ui_element_slot_05_main_menu_statistics.label_id = 31;

    int footer_row = 5;
    if (grim_interface_ptr->grim_get_config_var(100)) {
        copy_layer(ui_element_slot_footer_variant_a, ui_menu_item_element);
        ui_element_slot_footer_variant_a.pos = ui_layout_vec2_t(-60.0f, 450.0f);
        set_rect(ui_element_slot_footer_variant_a, 124.0f, 30.0f, 270.0f, -38.0f);
    ...
    copy_layer(ui_element_slot_footer_variant_b, ui_menu_item_element);
    ui_element_slot_footer_variant_b.pos
        = ui_layout_vec2_t(-60.0f, (float)(footer_row * 60 + 150));
    set_rect(ui_element_slot_footer_variant_b, 124.0f, 30.0f, 270.0f, -38.0f);
    ui_element_slot_footer_variant_b.on_activate = ui_menu_main_click_quit;
    ...
    for (i = 2; i <= 7; ++i) {
        ...
        if (!grim_interface_ptr->grim_get_config_var(100)) {
            ...
            table[i]->layers[1].texture_handle = texture_handles.ui_item_texts_texture;
            ...
            *(ui_layout_vec2_t *)&table[i]->layers[1].slot_02.u
                = ui_layout_vec2_t(1.0f, (float)(atlas_row + 1) * 0.125f);
            *(ui_layout_vec2_t *)&table[i]->layers[1].slot_03.u
                = ui_layout_vec2_t(0.0f, (float)(atlas_row + 1) * 0.125f);
        } else {
            table[i]->layers[1].texture_handle = texture_handles.ui_item_texts_texture;
            *(ui_layout_vec2_t *)&table[i]->layers[1].slot_00.u
                = ui_layout_vec2_t(0.0f, (float)atlas_row * 0.125f);
    ...
    } else if (config_screen_width > 800 && config_screen_width <= 1024) {
        transform_layers(&ui_element_table_end, 1.2f, 10.0f, 0.0f);
    }

    for (i = 1; i <= 7; ++i) {
        ui_element_table[i]->timeline_start_ms += i * 100;
        ui_element_table[i]->timeline_end_ms += i * 100;
        int stagger_x = (i - 2) * 20;
        if (stagger_x > 0) {
            ui_element_table[i]->pos.x -= (float)stagger_x;
        }
    }
    ...
    ui_layout_vec2_t slot_31_hover_max(ui_element_slot_31.hover_min.x + 280.0f,
    ...
    ui_element_slot_32_layout_c.pos = ui_layout_vec2_t(-55.0f, 430.0f);
    set_rect(ui_element_slot_32_layout_c, 124.0f, 30.0f, 270.0f, -38.0f);
    ui_element_slot_32_layout_c.layers[1].texture_handle
        = texture_handles.ui_item_texts_texture;
    set_atlas_row(ui_element_slot_32_layout_c, 7);
    ui_element_slot_32_layout_c.on_activate = ui_menu_click_back_contextual;
    ...
    ui_element_slot_23.layers[1] = ui_element_slot_04_main_menu_options.layers[1];
    ...
    ui_element_slot_24.layers[1] = ui_element_slot_footer_variant_b.layers[1];
    ...
    ui_element_slot_25.layers[1] = ui_element_slot_32_layout_c.layers[1];
    ...
    copy_layer(ui_element_slot_27, ui_menu_item_subtemplate_block_01);
    ...
    copy_layer(ui_element_slot_11, ui_menu_item_subtemplate_block_02);
    ...
    ui_element_slot_12_layout_a.pos = ui_layout_vec2_t(-55.0f, 462.0f);
    ui_element_slot_12_layout_a.layers[1] = ui_element_slot_32_layout_c.layers[1];
    ui_element_slot_12_layout_a.on_activate = ui_menu_click_back_contextual;
    ...
    copy_layer(ui_element_slot_30, ui_menu_item_subtemplate_block_01);
    ...
    ui_element_slot_14.pos = ui_layout_vec2_t(-165.0f, 200.0f);
    if (config_screen_width <= 640) {
        ((ui_layout_vec2_t &)ui_element_slot_14.pos) -= ui_layout_vec2_t(18.0f, 0.0f);
    }
    ...
    ui_element_slot_18_layout_b.pos = ui_layout_vec2_t(-155.0f, 420.0f);
    ui_element_slot_18_layout_b.layers[1] = ui_element_slot_32_layout_c.layers[1];
    ui_element_slot_18_layout_b.on_activate = ui_menu_main_click_options;
    ...
    copy_layer(ui_element_slot_35, ui_menu_item_subtemplate_block_01);
    ...
    copy_layer(ui_element_slot_37, ui_menu_item_subtemplate_block_01);
    ...
    copy_layer(ui_element_slot_39, ui_menu_item_subtemplate_block_01);
    ...
    ui_layout_vec2_t right_panel_position((float)(config_screen_width - 350), 200.0f);
    ui_element_slot_33.pos = right_panel_position;
    if (config_screen_width > 800) {
        ui_element_slot_33.pos.x = right_panel_position.x - 65.0f;
    } else {
        if (config_screen_width > 640) {
            ui_element_slot_33.pos.x = right_panel_position.x - 30.0f;
        } else {
            ui_element_slot_33.pos.x = right_panel_position.x + 10.0f;
        }
    }
    ui_element_slot_33.use_offset_render = 1;
    ui_element_slot_33.direction_flag = 1;

    ui_element_slot_08.pos = ui_layout_vec2_t(-190.0f, 122.0f);
    ...
    copy_layer(ui_element_slot_09, ui_menu_item_subtemplate_block_01);
    ui_element_slot_09.pos = ui_layout_vec2_t(-60.0f, 185.0f);
    ...
    ui_element_load(&ui_perk_prompt_element.layers[1], "ui\\ui_textLevelUp.jaz");
    {
        ui_layout_vec2_t levelup_offset(-230.0f, -27.0f);
        ui_element_set_rect(
            &ui_perk_prompt_element.layers[1], 75.0f, 25.0f, &levelup_offset.x);
    }

    for (i = 0; i < 4; ++i) {
        ui_layout_vertex_t *prompt_slot
            = (ui_layout_vertex_t *)&ui_perk_prompt_element.layers[0].slot_00 + i;
        prompt_slot->position.x -= 300.0f;
        ((ui_layout_vertex_t *)&ui_perk_prompt_element.layers[0].slot_00)[i].position
            *= 0.75f;

        ui_layout_vertex_t *levelup_slot
            = (ui_layout_vertex_t *)&ui_perk_prompt_element.layers[1].slot_00 + i;
        levelup_slot->position *= 0.85f;
        ((ui_layout_vertex_t *)&ui_perk_prompt_element.layers[1].slot_00)[i].position
            -= ui_layout_vec2_t(46.0f, 4.0f);
    }

    if (config_screen_width == 640) {
        ui_perk_prompt_element.pos = ui_layout_vec2_t(690.0f, 80.0f);
    } else {
        ui_perk_prompt_element.pos
