"""Replay the exact projectile source through the established native fixtures."""
...
def main():
    ...
    if args.suite in ("steering", "trail"):
        fixture_path = HERE.parent / "projectile-ownership-and-stack-2026-09-13" / "fixtures.py"
