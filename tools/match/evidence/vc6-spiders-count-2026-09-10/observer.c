...
{
    static unsigned long sites[] = {0x58249, 0x582e1, 0x582fd, 0x583c5};
    static unsigned long offsets[] = {0x281cd, 0x2930f, 0x294f3, 0x336f4};
    static void (*hooks[])(void) = {
        before_first_pass, before_address_pass, after_address_pass, before_allocation
    };
    HMODULE module;
    invoke_t invoke;
    protect_t protect;
