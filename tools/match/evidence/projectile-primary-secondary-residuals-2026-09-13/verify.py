...
def main():
    ...
    parser.add_argument("--suite", choices=(*FAMILIES, "primary-weapons", "rocket-impact", "explosion"), required=True)
    args = parser.parse_args()
    args.out.mkdir(parents=True, exist_ok=True)
    expanded = args.suite not in FAMILIES
    directory = HERE if expanded else HERE.parent / (FAMILIES[args.suite] + "-2026-09-11")
    ...
    before_path = HERE.parent / "projectile-residual-decomposition-2026-09-13/before.cpp"
    before = before_path.read_text()
    assert sha(before.encode()) == "90b9bb4a39f0efd852395367bd11f71113b8812b15144301b4914f18423ac730"
