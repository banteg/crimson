"""Rebuild stock source controls for highscore label copies and storage boundaries."""
...
sha = previous.sha
WITNESS = "native-boundaries-gate-0-items-1"


def sources():
    parents = {"previous/" + k: v[0] for k, v in previous.sources().items()}
    result = {}
