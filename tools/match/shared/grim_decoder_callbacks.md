...
The image-decoder cluster contributes fifty-nine exact callback, state, and cleanup
...
Altogether the fifty-nine functions cover 2,294 bytes and 887 instructions in the
