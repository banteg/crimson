...
The image-decoder cluster contributes eighty-five exact callback, state, and cleanup
...
Altogether the eighty-five functions cover 3,864 bytes and 1,448 instructions in the
