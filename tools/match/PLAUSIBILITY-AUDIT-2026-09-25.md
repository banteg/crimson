...
- **`player_render_overlays` alpha byte copy.** Settled: the `memcpy` became a
  one-float wrapper member assigned in the tint constructor, still byte-exact.
  Plain float spellings reach 96.73%
