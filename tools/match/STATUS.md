...
Fuzzy-weighted alignment is **334503/341992** code bytes (**97.8%**).

Remaining exact-match debt is **3 functions**, **29176 code bytes**, and **7489 fuzzy-gap bytes**.
...
**3** non-exact scratch-backed functions hold **7489 fuzzy-gap bytes**. The top 5 hold **100.0%** of that gap; the top 10 hold **100.0%**.

Current-baseline experiments cover **0 functions / 0 gap bytes**; **3 / 7489** are historical-only; **0 / 0** have no recorded experiments.
...
|---:|---|---|---:|---|---|---|---:|---:|---|
| 1 | crimsonland.exe | player_update | 4215 | semantic-complete | compiler,references | historical-only | 0/82 | 0 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 2 | crimsonland.exe | projectile_render | 3241 | incomplete | analysis,compiler,references | historical-only | 0/98 | 0 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| crimsonland.exe | 668/671 | 291651/320827 | 90.9% | 313338/320827 | 97.7% | 671/671 | 320827/320827 | 100.0% | 668/671 |
| grim.dll | 139/139 | 21165/21165 | 100.0% | 21165/21165 | 100.0% | 139/139 | 21165/21165 | 100.0% | 139/139 |

## crimsonland.exe

**668/671** functions (**99.6%**), **291651/320827** bytes (**90.9%**), **313338/320827** fuzzy-weighted bytes (**97.7%**), **671/671** reproducible candidates covering **320827/320827** bytes (**100.0%**), **668/671** scratches verified.
...
| wip | player_update | 0x004136b0 | 16257 | 12042/16257 | 4215 | 4151/4206 | 74.07% | 7/4206 | 859/0/0 |  | core-player-simulation |
...
| wip | projectile_render | 0x00422c70 | 12551 | 9310/12551 | 3241 | 3000/3021 | 74.17% | 0/3021 | 537/0/0 |  | laser-primary-plasma-beam-plague-and-secondary-projectile-passes |
