...
Relocation-aware encoded-body identity: **795/810** evaluated functions. Normalized exactness is reported separately below; recognized terminal padding is excluded.

Scope: `port` from `analysis/matching_scope.json`.

Regenerate with `uv run crimson match checkpoint`.

**797/810** functions matched exactly (**98.4%**), **260791/341992** code bytes (**76.3%**). Byte totals are manifest function extents with terminal padding trimmed.

Fuzzy-weighted alignment is **320568/341992** code bytes (**93.7%**).

Remaining exact-match debt is **13 functions**, **81201 code bytes**, and **21424 fuzzy-gap bytes**.
...
**13** non-exact scratch-backed functions hold **21424 fuzzy-gap bytes**. The top 5 hold **84.8%** of that gap; the top 10 hold **99.4%**.

Current-baseline experiments cover **1 functions / 574 gap bytes**; **12 / 20850** are historical-only; **0 / 0** have no recorded experiments.
...
| 11 | crimsonland.exe | creature_handle_death | 88 | semantic-complete | compiler | historical-only | 0/17 | 0 | repeated-variants,repeated-specs,variant-errors,historical-only |
| 12 | crimsonland.exe | quest_spawn_timeline_update | 32 | semantic-complete | compiler | historical-only | 0/8 | 0 | variant-errors,historical-only |
| 13 | crimsonland.exe | quest_build_spiders_inc | 8 | semantic-complete | compiler | historical-only | 0/37 | 0 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| crimsonland.exe | 658/671 | 239626/320827 | 74.7% | 299403/320827 | 93.3% | 671/671 | 320827/320827 | 100.0% | 658/671 |
| grim.dll | 139/139 | 21165/21165 | 100.0% | 21165/21165 | 100.0% | 139/139 | 21165/21165 | 100.0% | 139/139 |

## crimsonland.exe

**658/671** functions (**98.1%**), **239626/320827** bytes (**74.7%**), **299403/320827** fuzzy-weighted bytes (**93.3%**), **671/671** reproducible candidates covering **320827/320827** bytes (**100.0%**), **658/671** scratches verified.
...
| match | demo_trial_overlay_render | 0x004047c0 | 2413 | 2413/2413 | 0 | 636/636 | 100.00% | 636/636 | 175/0/0 |  | demo-trial-overlay-render-and-actions |
...
| match | perk_apply | 0x004055e0 | 885 | 885/885 | 0 | 241/241 | 100.00% | 241/241 | 76/0/0 |  | perk-immediate-effect-dispatch |
| match | gameplay_render_world | 0x00405960 | 625 | 625/625 | 0 | 184/184 | 100.00% | 184/184 | 56/0/0 |  | gameplay-world-render-coordinator |
| match | perk_selection_screen_update | 0x00405be0 | 1347 | 1347/1347 | 0 | 314/314 | 100.00% | 314/314 | 119/0/0 |  | perk-choice-menu-and-selection-flow |
...
| match | survival_update | 0x00407cd0 | 2102 | 2102/2102 | 0 | 504/504 | 100.00% | 504/504 | 139/0/0 |  | survival-handouts-milestones-and-edge-wave-spawns |
...
| match | credits_screen_update | 0x0040d800 | 1857 | 1857/1857 | 0 | 454/454 | 100.00% | 454/454 | 176/0/0 |  | credits-scroll-and-secret-puzzle |
...
| match | credits_secret_alien_zookeeper_update | 0x0040f4f0 | 2612 | 2612/2612 | 0 | 638/638 | 100.00% | 638/638 | 158/0/0 |  | credits-secret-match3-board-timer-scoring-and-navigation |
...
| wip | player_update | 0x004136b0 | 16257 | 10412/16257 | 5845 | 4066/4206 | 64.05% | 7/4206 | 805/0/2 |  | core-player-simulation |
...
| wip | projectile_update | 0x00420b90 | 8409 | 5288/8409 | 3121 | 2183/2203 | 62.88% | 0/2203 | 426/0/13 |  | core-projectile-simulation |
| wip | projectile_render | 0x00422c70 | 12551 | 7483/12551 | 5068 | 2913/3021 | 59.62% | 0/3021 | 464/0/10 |  | laser-primary-plasma-beam-plague-and-secondary-projectile-passes |
...
| wip | player_render_overlays | 0x00428390 | 4582 | 4263/4582 | 319 | 1148/1148 | 93.03% | 9/1148 | 331/0/0 |  | player-sprites-shield-flash-and-native-residual-target-trail |
...
| match | highscore_sync_worker | 0x0042d0e0 | 1981 | 1981/1981 | 0 | 525/525 | 100.00% | 525/525 | 126/0/0 |  | online-highscore-submit-receive-worker |
| match | statistics_update_check_worker | 0x0042d8a0 | 1375 | 1375/1375 | 0 | 367/367 | 100.00% | 367/367 | 120/0/0 |  | statistics-version-update-check-worker |
...
| wip | creature_spawn_template | 0x00430af0 | 14099 | 12533/14099 | 1566 | 3161/3159 | 88.89% | 23/3159 | 357/0/1 |  | gameplay-spawn-switch |
...
| match | quest_build_survival_of_the_fastest | 0x00437060 | 861 | 861/861 | 0 | 228/228 | 100.00% | 228/228 | 0/0/0 |  | quest-survival-fastest-indexed-route-and-corner-construction |
...
| match | ui_scrollbar_update | 0x0043def0 | 1767 | 1767/1767 | 0 | 479/479 | 100.00% | 479/479 | 66/0/0 |  | ui-scrollbar-wheel-drag-navigation-and-column-rendering |
...
| match | unlocked_weapons_database_update | 0x00440110 | 2086 | 2086/2086 | 0 | 523/523 | 100.00% | 523/523 | 157/0/0 |  | unlocked-weapon-list-and-detail-panel |
...
| match | unlocked_perks_database_update | 0x00440960 | 2065 | 2065/2065 | 0 | 511/511 | 100.00% | 511/511 | 148/0/0 |  | unlocked-perk-list-prerequisite-and-description-panel |
...
| match | ui_element_render | 0x00446c40 | 1801 | 1801/1801 | 0 | 521/521 | 100.00% | 521/521 | 65/0/0 |  | ui-focus-panel-offset-and-counter-overlay-rendering |
...
| match | quest_select_menu_update | 0x00447d40 | 3436 | 3436/3436 | 0 | 803/803 | 100.00% | 803/803 | 284/0/0 |  | quest-stage-picker-hardcore-gating-and-start-routing |
...
| match | controls_menu_update | 0x00448cd0 | 21289 | 21289/21289 | 0 | 5421/5421 | 100.00% | 5421/5421 | 1579/0/0 |  | controls-device-schemes-key-axis-rebinding-and-render-flow |
...
| match | ui_menu_layout_init | 0x0044fcb0 | 7237 | 7237/7237 | 0 | 1422/1422 | 100.00% | 1422/1422 | 538/0/0 |  | menu-element-graph-layout-and-responsive-transforms |
