...
Current-baseline experiments cover **4 functions / 10309 gap bytes**; **1 / 1777** are historical-only; **0 / 0** have no recorded experiments.
...
| 2 | crimsonland.exe | projectile_render | 4389 | incomplete | analysis,compiler,references | current-stalled | 5/95 | 5 | repeated-variants,repeated-specs,stalled,metric-tradeoffs,variant-errors |
