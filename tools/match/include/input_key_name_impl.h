#ifndef INPUT_KEY_NAME_IMPL_H
#define INPUT_KEY_NAME_IMPL_H
...
#ifdef CONTROLS_INLINE_KEY_NAME
#define INPUT_KEY_NAME_DECL static __forceinline char *controls_key_name
#else
#define INPUT_KEY_NAME_DECL extern "C" char *input_key_name
#endif

INPUT_KEY_NAME_DECL(int key_code)
{
    if (key_code > 0xff) {
