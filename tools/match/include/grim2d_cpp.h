...
public:
    ...
    virtual bool grim_recreate_texture(int handle) = 0;
    ...
    virtual void grim_draw_rect_outline(float *xy, float width, float height);
    ...
    virtual void grim_draw_quad_rotated_matrix(float x, float y, float w, float h);
